...
/*
   ...
   public ModelAndView searchType(String type) {
      ...
      int TotalCount3 = pdao.TotalCount3();
      int page2 = 1;
      ...
      int maxPage = (int) (Math.ceil((double) TotalCount3 / pageCount));
      ...
      ArrayList<ProductDto> selectproductList = pdao.selectproductList(startRow, endRow, type);
