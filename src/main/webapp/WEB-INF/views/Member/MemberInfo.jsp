...
<body>
    ...
    <section class="hero">
        ...
        <div class="background2">
                        	<div class="window2">
                        		<div class="popup2">
                        		<p>아이디&nbsp;&nbsp;:&nbsp;&nbsp;<input type="hidden" id ="mid" name ="mid" value="${memberInfo.mid }">${memberInfo.mid } </p>
...
function update() {
	...
	$.ajax({
		url : "memberModify",
		type : "get",
		data : { "mid" : mid, "mpw" : mpw, "mtel" : mtel, "memail2" : memail, "emailDomain" : memailDomain, "mpostercode" : mpostercode, "maddr" : maddr, "mdetailaddress" : mdetailaddress, "mextraaddress" : mextraaddress },
		async:false,
