							...
							<div class="margin">
								<div class="p-5">
									<div class="text-center ">
										<h1 class="h4 text-gray-900 mb-4" style="font-weight: bold;">비밀번호 확인</h1>
									</div>
									<form class="user" method="post" action="memberInfo">
										...
										<button type="submit" class="btn text-white  btn-user btn-block" style="background-color: #000000;">확인</button>
										<hr>
									</form>
								</div>
							</div>
