...
<body>
	<div class="col-lg-3">
		<div class="header__logo" style="text-align: left;" id="text_ls">
			<h2>
				<a href="main"
					style="font-size: 36px; font-style: oblique; font-weight: bold; font-family: text_ls;">
					L&CSS </a>
			</h2>
		</div>
	</div>
	<div class="col-lg-9">
		<nav class="header__menu2"
			...
			<ul>
				...
				<li><a href="fullMain">상품</a></li>
				<c:choose>
					<c:when test="${sessionScope.loginType == 1 }">
						<li><a>카페</a>
							<ul class="header__menu__dropdown">
								<li><a href="mycafeInsert?loginId=${sessionScope.loginId }">내
										카페등록</a></li>
								<li><a href="mycafeInfo?loginId=${sessionScope.loginId }">내
										카페정보</a></li>
								<li><a href="mycafeMenu">메뉴등록</a></li>
					...
					<c:when test="${sessionScope.loginType == 2 }">
						...
						<li><a>업체</a>
							<ul class="header__menu__dropdown">
								<li><a
									href="MycompanyInsert?loginId=${sessionScope.loginId }">내
										업체등록</a></li>
								<li><a
									href="mycompanyInfo?loginId=${sessionScope.loginId }">내
										업체정보</a></li>
								<li><a href="myProduct?loginId=${sessionScope.loginId }">상품등록</a>
								</li>
				...
				<li><a href="groupBuyBoard">공동구매</a></li>
				<li style="text-align: right; float: right;">
				<c:if test="${sessionScope.loginId != null }">
					<c:choose>
						<c:when test="${fn:substring(sessionScope.myProfile,0,4)=='http'}">
							<img class="imgO" alt="" src="${sessionScope.myProfile}">
						</c:when>
						<c:otherwise>
