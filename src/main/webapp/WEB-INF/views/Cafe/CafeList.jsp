		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12">
				<div class="row">
					...
					<div class="back color-10 menu align-center expanded text-center SMN_effect-70" style="font-size: 24px; margin-left: 380px; margin-bottom: 30px; font-weight: bold;">
