						...
						<div class="margin">
							<div class="margin">
								<div class="p-5">
									...
									<form class="user" action="createMycafe" method="post"
										enctype="multipart/form-data">
										<div class="row form-group">
											<div class="col-6 form-group">
												<label>카페이름</label> <input type="text"
													class="form-control form-control-user" id="cfname"
													name="cfname" aria-describedby="emailHelp">
											</div>
											<div class="col-6 form-group">
												<label>전화번호</label> <input type="text"
													class="form-control form-control-user" id="cftel"
													name="cftel" placeholder="전화번호 - 포함">
											</div>
										</div>
										<div class="form-group">
											<label>카페링크</label> <input type="text"
												class="form-control form-control-user" id="cflink"
												name="cflink">
										</div>
										<div class="row form-group">
											<div class="col-6 form-group">
										...
										<div class="row">
											<div class="col-12">
												<input class="form-control form-control-user" type="text"
													id="cfaddr" name="cfaddr" placeholder="주소"> <br>
											</div>
										</div>
										...
										<div class="row form-group">
											...
											<div class="col-6 form-group">
												<input class="form-control form-control-user" type="text"
													id="cfextraaddress" name="cfextraaddress" placeholder="참고항목">
											</div>
										</div>
