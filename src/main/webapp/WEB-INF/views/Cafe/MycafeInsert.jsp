						...
						<div class="margin">
							<div class="margin">
								<div class="p-5">
									...
									<form class="user" action="createMycafe" method="post" enctype="multipart/form-data">
										...
										<div class="row form-group">
											<div class="col-6 form-group">
												<label>카페 이미지</label>
												<input type="file" class="form-control form-control-user" id="cfimgs" name="cfimgs" onchange="readURL(this);">
											</div>
											<div class="col-6 form-group">
										...
										<div class="row form-group">
											...
											<div class="col-6 form-group">
												<input class="form-control form-control-user" type="text" id="cfpostcode" name="cfpostcode" placeholder="우편번호">
											</div>
										</div>
										<div class="row">
											<div class="col-12">
												<input class="form-control form-control-user" type="text" id="cfaddr" name="cfaddr" placeholder="주소">
												<br>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col-6 form-group">
												<input class="form-control form-control-user" type="text" id="cfdetailaddress" name="cfdetailaddress" placeholder="상세주소">
											</div>
											<div class="col-6 form-group">
												<input class="form-control form-control-user" type="text" id="cfextraaddress" name="cfextraaddress" placeholder="참고항목">
											</div>
										</div>
										<button type="submit" class="btn text-white  btn-user btn-block" style="background-color: #000000;">카페추가</button>
										<input type="hidden" name="cfmid" id="cfmid" value=${sessionScope.loginId }>
									</form>
									<hr>
								</div>
							</div>
