      ...
      <div class="row">
         ...
         <div class="col-lg-12 col-md-12">
            <div class="row">
                        ...
                        <c:choose>
                           <c:when test="${comList.cmimg == null }">
                              <div class="blog__item__pic">
                                 <img alt=""
                                    style="width: 200px; height: 100px; padding-right: 30px; padding-left: 30px;"
               ...
               <div style="font-size: 16px; margin-left: 550px; margin-bottom: 30px;">
