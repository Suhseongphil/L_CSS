...
<body>
	...
	<section class="hero">
				...
				<div class="col-lg-4">
					...
					<div class="p-3" style="margin-top: 10px;">
						<div class="hero__text2">
							<span style="font-size: 22px;">내&nbsp;업체정보</span> <br> <br>
							<br>
				...
				<div class="row col-lg-8">
					...
					<div class="p-5" style="margin-top: 20px;">
						<div class="hero__text">
							<label>회사이미지</label><br> <img class="imgclass" alt=""
								src="${pageContext.request.contextPath }/resources/fileUpLoad/CompanyFile/${mycompanyInfo.cmimg}">
						</div>
					</div>
		...
		<div class="background2">
			<div class="window2">
				<form class="user" action="mycompanyModify" method="post"
					enctype="multipart/form-data">
					<div class="popup2">
						<div
							style="margin-left: 20px; margin-right: 400px; margin-top: 20px;">
							<label>회사이름</label> <input type="text" id="cmname" name="cmname"
								value="${mycompanyInfo.cmname }"
								class="form-control form-control-user">
						</div>
						<br>
						<div class="row form-group">
							<div class="col-5 form-group" style="margin-left: 20px;">
								<label>전화번호</label> <input type="text" id="cmtel" name="cmtel"
									value="${mycompanyInfo.cmtel }">

							</div>
							<br>
						<div class="row form-group">
							<div class="col-6 form-group">
								<label>회사링크</label> <input type="text" id="cmlink" name="cmlink"
									value="${mycompanyInfo.cmlink }">
							</div>
						</div>
						<br>
							<div class="col-6 form-group">
								<label>회사 이미지</label> <input type="file"
									class="form-control form-control-user" id="cmimgs"
									name="cmimgs" onchange="readURL(this);"> <img
						...
						<div class="row form-group">
							...
							<div class="col-6 form-group" style="margin-right: 20px;">
								<input class="form-control form-control-user" type="text"
									id="cmpostcode" name="cmpostcode"
									value="${mycompanyInfo.cmpostcode }" placeholder="우편번호">
							</div>
						</div>
						<div class="row">
							<div class="col-6" style="margin-left: 20px;">
								<input class="form-control form-control-user" type="text"
									id="cmaddr" name="cmaddr" value="${mycompanyInfo.cmaddr }"
									placeholder="주소"> <br>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-4 form-group" style="margin-left: 20px;">
								<input class="form-control form-control-user" type="text"
									id="cmdetailaddress" name="cmdetailaddress"
									value="${mycompanyInfo.cmdetailaddress }" placeholder="상세주소">
							</div>
							<div class="col-6 form-group" style="margin-left: 20px;">
								<input class="form-control form-control-user" type="text"
									id="cmextraaddress" name="cmextraaddress"
									value="${mycompanyInfo.cmextraaddress }" placeholder="참고항목">
							</div>
						</div>
						<input type="hidden" id="cmmid" name="cmmid"
							value="${mycompanyInfo.cmmid }">
