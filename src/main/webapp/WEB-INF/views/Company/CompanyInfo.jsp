						...
						<div class="blog__item__pic">
							<c:choose>
								<c:when test="${comInfo.cmimg == null }">
									<img alt="" style="width: 450px; height: 500px; padding-right: 30px; padding-left: 30px; margin-top: -50px; margin-left: 100px;" src="${pageContext.request.contextPath }/resources/fileUpLoad/MenuFile/BasicMenu/BS011.png">
								</c:when>
								<c:otherwise>
									<img style="width: 450px; height: 250px; padding-right: 30px; padding-left: 30px; margin-top: 50px; margin-left: 80px;" src="${pageContext.request.contextPath }/resources/fileUpLoad/CompanyFile/${comInfo.cmimg}" alt="">
								</c:otherwise>
							</c:choose>
						</div>

						<div style="margin-top: -150px; margin-left: 30px;">
							<h2 style="text-align: center; margin-top: 30px; margin-left: -500px; font-weight: bold;">${comInfo.cmname}</h2>
							<div id="map2" style="width: 500px; height: 500px; margin-top: 35px;"></div>
