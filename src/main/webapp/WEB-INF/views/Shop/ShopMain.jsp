...
<body>
		...
		<div class="container" style="padding-left: 80px;">
			<div class="col-lg-12 col-md-3" style="margin-left: 100px;">
				<div class="product__discount">
					...
					<div class="row"
						style="margin-top: -400px; padding-left: 300px; padding-right: 300px;">
								...
								<div class="col-lg-2">
									<div class="product__discount__item">
										...
										<div class="product__discount__item__text">
											...
											</a> <a href="productInfo?pdcode=${pro.pdcode}"> <span>${pro.pdname}</span>
											</a>
											<h5>
	...
	<section>
		<div class="row"
			style="margin-left: 400px; margin-right: 300px; margin-top: 200px;">
			<c:forEach items="${selectproductList}" var="pro">
				<div class="col-lg-3">
					<div class="product__discount__item">
						<a href="productInfo?pdcode=${pro.pdcode}"> <c:set
								var="imgCheck" value="${pro.pdimg }" /> <c:choose>
						...
						<div class="product__discount__item__text">
							<c:choose>
								...
								<c:otherwise>
									<a onclick="loginCheck()"> <i class="fa fa-shopping-cart"></i>
									</a>
								</c:otherwise>
							</c:choose>
							<a href="productInfo?pdcode=${pro.pdcode}"> <span>${pro.pdname}</span>
							</a>
							<h5>
								<a href="productInfo?pdcode=${pro.pdcode}">${pro.pdtype}</a>
							</h5>
