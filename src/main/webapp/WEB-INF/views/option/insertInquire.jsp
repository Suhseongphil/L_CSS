	...
	<div class="cart-box-main">
		<div class="container">
			<div class="row">
				...
				<form action="insertInquire" method="post"
					...
					<div class="row">
						...
						<div class="col-6">
							<h5>
								작성자 : ${sessionScope.loginId} <input type="hidden" id="iqmid"
									name="iqmid" value="${sessionScope.loginId}"> <br>
							</h5>
						</div>
					...
					<div class="row">
						<div class="col-12">
							<h5>
								제목 : <input type="text" id="iqtitle" name="iqtitle">
							</h5>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-4">
							<h5>
								문의내용 <br>
								<br>
								<textarea name="iqcomment" id="iqcomment"
					...
					<div class="row">
						<div class="col-4">
							<h5>
								첨부파일 : <input type="file" name="iqfile" id="iqdile">
							</h5>
						</div>
					</div>
					<button>작성하기</button>
...
<script type="text/javascript">
	...
	function cartPrint(mycart) {
		...
		for (var i = 0; i < mycart.length; i++) {
			...
			output += "<div class=\"col-2 divpadding\">"
			output += "<h5>" + mycart[i].cttotal
					+ "원 &nbsp;&nbsp;<span class=\"icon_close\"></span></h5>";
