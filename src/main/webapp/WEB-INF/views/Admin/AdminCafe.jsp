		...
		<div class="container">
			<form action="adminCreateCafeInfo" enctype="multipart/form-data">
				<div class="row cafeInput">
					...
					<div class="col-2">
						<br>
						<button class="insert-btn" type="button" id="cafeSend">카페추가</button>
					</div>
...
<script type="text/javascript">
	...
	function cafeInfoPrint(cafe) {
		...
		for (var i = 0; i < cafe.length; i++) {
			output += "<br>";
			output += "<div class=\"row\" style=\"border: 3px solid gray; padding: 10px 10px 10px 10px;\">"; // 맨위

			output += "<div class=\"col-3\">";
			if (cafe[i].cfimg != null) {
				/* console.log(i + "번 이미지 :" + company[i].cmimg.split("/")[1]); */
				output += "<img style=\"width:170px; height:100px;\" alt=\"\" src=\"${pageContext.request.contextPath }/resources/fileUpLoad/CafeFile/"
						+ cafe[i].cfimg.split("/")[1] + "\">";
			} else {
				output += "<span style=\"margin-top:15px; margin-bottom:15px;\">이미지없음</span>";
			}
			output += "<br><img style=\"width:170px; height:100px; margin-top:5px;\" alt=\"\" src=\"${pageContext.request.contextPath }/resources/fileUpLoad/CafeFile/"+ cafe[i].cfsigimg + "\">";
			output += "</div>";

			output += "<div class=\"col-7\"><div class=\"cafeList-mt\">";
			...
			if (cafe[i].cflink == "없음") {
				...
				output += "<a href=\""+ cafe[i].cflink +"\">" + cafe[i].cflink
						+ "</a><br>";
			}
			...
			output += "<div class=\"col-2\"><div class=\"cafeList-mt\">";
...
<script src="${pageContext.request.contextPath }/resources/js/daumPostSearch.js"></script>
